...
getwd()
setwd("/users/justinvhuang/desktop/logistic_regression")
...
# check stucture, level and summary of everwrk
str(NH11$everwrk)
level(NH11$everwrk) 
...
# check stucture, level and summary of age_p
str(NH11$age_p) 
summary(NH11$age_p)
levels(NH11$age_p) 


# check stucture, level and summary of r_maritl 
str(NH11$r_maritl) 
...
# Create a dataset with predictors set at desired levels# for 20, 30, 40 and 50 
predDat <- with(NH11, expand.grid(age_p = c(20,30,40,50), r_maritl = unique(NH11$r_maritl)))
